...
int main(int argc, char *argv[]){
    ...
    Opts opt1{ OptionSpec(file, "File", "file", 'f').set_expects_arg(true), 
                      ...
                      positional(x, "a double value", "x"),
                      positional(y, "a double value", "y"),
                    };
    //*
    Opts opt{
    ...
    std::cout << "l == [";
    for(auto e : l) std::cout << std::boolalpha << e << ", ";
    std::cout << "]" << std::endl;
    std::cout << "v == [";
